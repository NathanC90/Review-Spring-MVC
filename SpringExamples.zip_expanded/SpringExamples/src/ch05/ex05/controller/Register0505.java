...
import ch05.ex05.model.DAOUtil;
import ch05.ex05.model.Member;
import ch05.ex05.model.MemberDAO;

@WebServlet("/ch05/ex05/register0505.do")
public class Register0505 extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request,
		...
		if (!errorMsg.isEmpty()) {
			RequestDispatcher rd = request.getRequestDispatcher("ch05_ex03_form.jsp");
